...
PILE_DATASET="\
1.0 /dataset/home/tianzhi/code/Megatron-LM/data/openwebtext-gpt2_text_document"

TOK_PATH="/dataset/home/tianzhi/code/Megatron-LM/data/gpt2_tokenizer"
# NOTE: We don't train for enough tokens for the
# split to matter.
DATA_ARGUMENTS="\
--data-path ${PILE_DATASET} \
--vocab-file $TOK_PATH/gpt2-vocab.json \
--merge-file $TOK_PATH/gpt2-merges.txt \
